...
// Odemčená editace non-draft faktury (?force=1 z tlačítka „Odemknout k editaci"
// na detailu, jen admin) — zobrazí varovný banner; server akci audituje
// jako purchase_invoice.force_updated.
const isForce = computed(() => String(route.query.force ?? '') === '1')
...
<template>
  <div class="space-y-4 max-w-5xl">
    ...
    <div v-if="isForce && isEdit" class="rounded-md border border-warning-500/50 bg-warning-50 p-4">
